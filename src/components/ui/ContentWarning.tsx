...
export function ContentWarning({ onDismiss }: ContentWarningProps) {
  ...
  return (
    ...
    >
      <div className="max-w-lg text-center px-6 sm:px-4">
        <h2
          id="cw-title"
          className="text-xl sm:text-2xl font-display text-ink-50 mb-4 sm:mb-6"
        >
          內容提醒
        </h2>
        <p
          id="cw-desc"
          className="text-ink-300 text-sm sm:text-base leading-relaxed mb-6 sm:mb-8"
        >
        ...
        <button
          ...
          className="px-6 py-3 sm:py-2 border border-ink-400 text-ink-100 font-mono text-sm
